<?php
/**
 * Page principale du site Voyage en Guadeloupe
 * 
 * Cette page affiche le planning du voyage en Guadeloupe
 * avec une adaptation responsive selon l'appareil utilisé
 */
